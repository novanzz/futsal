      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="<?php echo site_url('user/bookings'); ?>" method="post">
            <input type="text" class="form-control" name="id_lapangan" value="1" id="exampleInputEmail1" hidden>
  ...
  <table class="table table-bordered table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <?php echo $key->id_pemesanan; ?>
        </td>
        <td>
          <?php echo $key->tanggal_main; ?>
        </td>
        <td>
          <?php echo $key->jam_mulai; ?>
        </td>
        <td>
          <?php echo $key->jam_slesai; ?>
        </td>
        <td>
          <?php echo $key->nama_pemesan; ?>
        </td>
        <td>
          <?php echo $key->nama_tim; ?>
        </td>
        <td>
          <?php echo $key->nama_status; ?>
        </td>
      </tr>
      <?php endforeach; ?>
    </tbody>
