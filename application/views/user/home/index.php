...
<div class="album py-5 bg-light">
  <div class="container">
    ...
    <div class="col-md-4">
      <a href="<?php echo site_url('UserHome/lapangan2'); ?>">
        <div class="card mb-4 box btn btn-sm btn-outline-secondary">
  ...
  <div class="col-md-4">
    <a href="<?php echo site_url('UserHome/lapangan3'); ?>">
      <div class="card mb-4 box btn btn-sm btn-outline-secondary">
...
<div class="col-md-4">
  <a href="<?php echo site_url('UserHome/lapangan4'); ?>">
    <div class="card mb-4 box btn btn-sm btn-outline-secondary">
...
<div class="col-md-4">
  <a href="<?php echo site_url('UserHome/lapangan5'); ?>">
    <div class="card mb-4 box btn btn-sm btn-outline-secondary">
...
<div class="col-md-4">
  <a href="<?php echo site_url('UserHome/lapangan6'); ?>">
    <div class="card mb-4 box btn btn-sm btn-outline-secondary">
