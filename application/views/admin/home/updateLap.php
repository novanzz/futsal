...
<div class="container">
  <div class="row" style="margin-left:36%; margin-top:1%;">
    <div class="jumbotron" style="background-color:#C8C8C8;">
      <h2 class="text-center">Update Lapangan</h2>
      <hr>
      <form action="<?php echo site_url('AdminHome/editLap/'.$id)?>" method="post" enctype="multipart/form-data">
      <label for="nama_lapangan">Nama Lapangan :</label>
      <br>
          <input name="nama_lapangan" value="<?php echo $data->nama_lapangan ?>">
          <br/>
